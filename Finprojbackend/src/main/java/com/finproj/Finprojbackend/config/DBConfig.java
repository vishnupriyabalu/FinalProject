package com.finproj.Finprojbackend.config;
...
import com.finproj.Finprojbackend.dao.*;

import com.finproj.Finprojbackend.model.*;

@Configuration
@ComponentScan("com.finproj.Finprojbackend")
...
public class DBConfig {
	...
	public Category_dao getCategory_dao(SessionFactory sessionFactory)
	{
		System.out.println("-- CategoryDAO Object Creation--");
		return new Category_dao(sessionFactory);
	}
	@Autowired
	@Bean(name="supplierDAO")
	public Supplier_DAO getSupplier_DAO(SessionFactory sessionFactory)
	{
		System.out.println("-- SupplierDAO Object Creation--");
		return new Supplier_DAO(sessionFactory);
	}
	@Autowired
	...
	@Autowired
	@Bean(name="cartDAO")
	public CartDAO getCartItem(SessionFactory sessionFactory)
	{
